...
public class ExpressionGameActivityTest extends AndroidJUnitRunner {
    ...
    public void moveToCreated() {
        final ActivityScenario<ExpressionGameActivity> scenario = ActivityScenario.launch(ExpressionGameActivity.class);
