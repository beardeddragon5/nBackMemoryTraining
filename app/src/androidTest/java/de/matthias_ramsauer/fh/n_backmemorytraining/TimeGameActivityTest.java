...
public class TimeGameActivityTest extends AndroidJUnitRunner {
    ...
    public void moveToCreated() {
        final ActivityScenario<TimeGameActivity> scenario = ActivityScenario.launch(TimeGameActivity.class);
