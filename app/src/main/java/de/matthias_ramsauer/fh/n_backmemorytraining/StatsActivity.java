...
public class StatsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder.addPage(getResources().getText(R.string.stats_list), StatsListFragment.newInstance());
        builder.addPage(getResources().getText(R.string.stats_graph), StatsGraphFragment.newInstance());
