...
\setkomafont{subsection}{\color{SkyBlue}\scshape\rmfamily\bfseries\large}
\setkomafont{subsubsection}{\color{SkyBlue}\scshape\rmfamily\mdseries\large}
\setkomafont{paragraph}{\color{Black}\bfseries}
